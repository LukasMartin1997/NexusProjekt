...
$beschwrer = urlbea("https://euw1.api.riotgames.com/lol/summoner/v3/summoners/88817853?api_key=RGAPI-b1feb78c-bf06-4ab2-97ca-d4dff08a3344");
$champs = urlbea("https://euw1.api.riotgames.com/lol/champion-mastery/v3/champion-masteries/by-summoner/88817853?api_key=RGAPI-b1feb78c-bf06-4ab2-97ca-d4dff08a3344");
$liga = urlbea("https://euw1.api.riotgames.com/lol/league/v3/positions/by-summoner/88817853?api_key=RGAPI-b1feb78c-bf06-4ab2-97ca-d4dff08a3344");
$match = urlbea("https://euw1.api.riotgames.com/lol/match/v3/matchlists/by-account/228746078/recent?api_key=RGAPI-b1feb78c-bf06-4ab2-97ca-d4dff08a3344");
...
$DataSet->AddPoint(array($toplane,$jungle,$midlane,$adc,$support),"Serie1");  
 ...
 $Test->Render("mohi/diagram.png");  
 
 echo("<img src='mohi/diagram.png'>"); 
echo("</fieldset>");
echo("<br>");
echo("</fieldset>");
?>
...
<iframe src="mohi/kommentare.txt" width="100%" frameBorder="1" id="kommentare"></iframe>
...
{
	echo("
<form method='post' action='mohi/senden.php'><p><label>Nachricht:<br><textarea name='kommentar' cols='50' rows='8' id='kommentar'></textarea></label></p><input type='submit' value='Senden'></form>
<br>
<br>
");
...
{
echo("<a href='mohi/bearbeiten.php'>Chat bearbeiten</a><br><br>");
}
}
?>
</div>
