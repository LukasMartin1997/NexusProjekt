...
$beschwrer = urlbea("https://euw1.api.riotgames.com/lol/summoner/v3/summoners/80149237?api_key=RGAPI-b1feb78c-bf06-4ab2-97ca-d4dff08a3344");
$champs = urlbea("https://euw1.api.riotgames.com/lol/champion-mastery/v3/champion-masteries/by-summoner/80149237?api_key=RGAPI-b1feb78c-bf06-4ab2-97ca-d4dff08a3344");
$liga = urlbea("https://euw1.api.riotgames.com/lol/league/v3/positions/by-summoner/80149237?api_key=RGAPI-b1feb78c-bf06-4ab2-97ca-d4dff08a3344");
$match = urlbea("https://euw1.api.riotgames.com/lol/match/v3/matchlists/by-account/224777187/recent?api_key=RGAPI-b1feb78c-bf06-4ab2-97ca-d4dff08a3344");
$runen = urlbea("https://euw1.api.riotgames.com/lol/platform/v3/runes/by-summoner/80149237?api_key=RGAPI-b1feb78c-bf06-4ab2-97ca-d4dff08a3344");
$runenstats = urlbea("https://euw1.api.riotgames.com/lol/static-data/v3/runes?locale=de_DE&tags=stats?api_key=RGAPI-b1feb78c-bf06-4ab2-97ca-d4dff08a3344");

$datena= convertObjectToArray (json_decode($beschwrer));
...
$datene = convertObjectToArray(json_decode($runen));
$datenf = convertObjectToArray(json_decode($runenstats));
...
$DataSet->AddPoint(array($toplane,$jungle,$midlane,$adc,$support),"Serie1");  
 ...
 $Test->Render("alex/diagram.png");  
 
 echo("<img src='alex/diagram.png'>"); 
echo("</fieldset>");
echo("<br>");
echo("</fieldset>");
?>
...
<iframe src="alex/kommentare.txt" width="100%" frameBorder="1" id="kommentare"></iframe>
...
{
	echo("
<form method='post' action='alex/senden.php'><p><label>Nachricht:<br><textarea name='kommentar' cols='50' rows='8' id='kommentar'></textarea></label></p><input type='submit' value='Senden'></form>
<br>
<br>
");
...
{
echo("<a href='alex/bearbeiten.php'>Chat bearbeiten</a><br><br>");
}
}
?>
</fieldset>
