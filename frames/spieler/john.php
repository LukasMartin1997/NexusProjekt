...
$beschwrer = urlbea("https://euw1.api.riotgames.com/lol/summoner/v3/summoners/24783625?api_key=RGAPI-b1feb78c-bf06-4ab2-97ca-d4dff08a3344");
$champs = urlbea("https://euw1.api.riotgames.com/lol/champion-mastery/v3/champion-masteries/by-summoner/24783625?api_key=RGAPI-b1feb78c-bf06-4ab2-97ca-d4dff08a3344");
$liga  = urlbea("https://euw1.api.riotgames.com/lol/league/v3/positions/by-summoner/24783625?api_key=RGAPI-b1feb78c-bf06-4ab2-97ca-d4dff08a3344");
$match = urlbea("https://euw1.api.riotgames.com/lol/match/v3/matchlists/by-account/29295942/recent?api_key=RGAPI-b1feb78c-bf06-4ab2-97ca-d4dff08a3344");
...
$DataSet->AddPoint(array($toplane,$jungle,$midlane,$adc,$support),"Serie1");  
 ...
 $Test->Render("john/diagram.png");  
 
echo("<img src='john/diagram.png'>"); 
echo("</fieldset>");
echo("<br>");
echo("</fieldset>");
?>
...
<iframe src="john/kommentare.txt" width="100%" frameBorder="1" id="kommentare"></iframe>
<?php
...
{
	echo("
<form method='post' action='john/senden.php'><p><label>Nachricht:<br><textarea name='kommentar' cols='50' rows='8' id='kommentar'></textarea></label></p><input type='submit' value='Senden'></form>
<br>
<br>
");
...
{
echo("<a href='john/bearbeiten.php'>Chat bearbeiten</a><br><br>");
}
}
?>
</fieldset>
